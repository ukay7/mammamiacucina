      ...
      <div class="ps-section--cart pt-100 pb-100">
        <div class="container">
          <div class="ps-compare">
            ...
            <div class="table-responsive">
              <table class="table">
                <tbody>
                  <tr>
                    <td>Images</td>
                    <td><img src="{{ asset('assets/images/cake/img-cake-12.jpg') }}" alt=""></td>
                    <td><img src="{{ asset('assets/images/cake/img-cake-12.jpg') }}" alt=""></td>
                    <td><img src="{{ asset('assets/images/cake/img-cake-12.jpg') }}" alt=""></td>
                  </tr>
                  <tr>
            ...
            <div class="text-right"><a class="ps-btn" href="#">Continue shopping<i class="fa fa-angle-right"></i></a></div>
          </div>
        </div>
      </div>
