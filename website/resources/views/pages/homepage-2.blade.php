...
@section('title', 'Bakery | Homepage 2')
...
@section('content')
    ...
    <div class="page-wrap">
      ...
      <div class="ps-section pt-80 pb-40">
        <div class="container">
          ...
          <div class="ps-section__content">
            <div class="ps-product-special">
              <div class="owl-slider ps-cake-list mb-50" data-owl-auto="true" data-owl-loop="false" data-owl-speed="10000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="false" data-owl-animate-in="" data-owl-animate-out="" data-owl-item="5" data-owl-item-xs="2" data-owl-item-sm="3" data-owl-item-md="4" data-owl-item-lg="5" data-owl-nav-left="&lt;i class=&quot;fa fa-angle-left&quot;&gt;&lt;/i&gt;" data-owl-nav-right="&lt;i class=&quot;fa fa-angle-right&quot;&gt;&lt;/i&gt;"><a class="ps-cake" href="javascript:;"><img src="{{ asset('assets/images/special/img-cr-1.jpg') }}" alt=""></a><a class="ps-cake" href="javascript:;"><img src="{{ asset('assets/images/special/img-cr-2.jpg') }}" alt=""></a><a class="ps-cake" href="javascript:;"><img src="{{ asset('assets/images/special/img-cr-3.jpg') }}" alt=""></a><a class="ps-cake" href="javascript:;"><img src="{{ asset('assets/images/special/img-cr-4.jpg') }}" alt=""></a><a class="ps-cake" href="javascript:;"><img src="{{ asset('assets/images/special/img-cr-5.jpg') }}" alt=""></a>
              </div>
              <div class="owl-slider ps-cake-detail" data-owl-auto="true" data-owl-loop="false" data-owl-speed="10000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="false" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-nav-left="&lt;i class=&quot;fa fa-angle-left&quot;&gt;&lt;/i&gt;" data-owl-nav-right="&lt;i class=&quot;fa fa-angle-right&quot;&gt;&lt;/i&gt;">
                <div class="ps-cake--detail">
                  <div class="ps-cake__thumbnail"><img src="{{ asset('assets/images/special/img-cr-1.jpg') }}" alt="">
                ...
                <div class="ps-cake--detail">
                  <div class="ps-cake__thumbnail"><img src="{{ asset('assets/images/special/img-cr-2.jpg') }}" alt="">
                  </div>
                  <div class="ps-cake__content">
                    <h3>Vanilla cupcake with red sugar flowers</h3>
                    <p>INGREDIENTS:</p>
                ...
                <div class="ps-cake--detail">
                  <div class="ps-cake__thumbnail"><img src="{{ asset('assets/images/special/img-cr-3.jpg') }}" alt="">
                    <div class="ps-badge ps-badge--large"><span>HOT</span></div>
                  </div>
                  <div class="ps-cake__content">
                    <h3>Vanilla cupcake with red sugar flowers</h3>
                ...
                <div class="ps-cake--detail">
                  <div class="ps-cake__thumbnail"><img src="{{ asset('assets/images/special/img-cr-4.jpg') }}" alt="">
                  </div>
                  <div class="ps-cake__content">
                    <h3>Vanilla cupcake with red sugar flowers</h3>
                    <p>INGREDIENTS:</p>
                ...
                <div class="ps-cake--detail">
                  <div class="ps-cake__thumbnail"><img src="{{ asset('assets/images/special/img-cr-5.jpg') }}" alt="">
                    <div class="ps-badge ps-badge--large"><span>HOT</span></div>
                  </div>
                  <div class="ps-cake__content">
                    <h3>Vanilla cupcake with red sugar flowers</h3>
      ...
      <div class="ps-section ps-section--testimonial--2 ps-background--overlay bg--parallax pt-80 pb-80" data-background="{{ asset('assets/images/parallax/img-bg-2.jpg') }}">
        <div class="container">
          <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="false" data-owl-animate-in="" data-owl-animate-out="" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-nav-left="&lt;i class=&quot;fa fa-angle-left&quot;&gt;&lt;/i&gt;" data-owl-nav-right="&lt;i class=&quot;fa fa-angle-right&quot;&gt;&lt;/i&gt;">
            <div class="ps-testimonial--2">
              <p>Trick or Treat! Give me something good to eat. Give me candy. Give me cake. Give me something sweet to take!</p>
              <p class="author">- Angel Dawson -</p>
            </div>
            <div class="ps-testimonial--2">
              <p>Trick or Treat! Give me something good to eat. Give me candy. Give me cake. Give me something sweet to take!</p>
              <p class="author">- Angel Dawson -</p>
          ...
          <div class="ps-section__content">
            ...
            <div class="mt-50">
                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                    <div class="ps-product">
                      <div class="ps-product__thumbnail">
                        <div class="ps-badge"><span>-50%</span></div><a class="ps-product__overlay" href="{{ route('theme.product-detail') }}"></a><img src="{{ asset('assets/images/cake/img-cake-13.jpg') }}" alt="">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                    <div class="ps-product">
                      <div class="ps-product__thumbnail">
                        <div class="ps-badge"><span>-50%</span></div><a class="ps-product__overlay" href="{{ route('theme.product-detail') }}"></a><img src="{{ asset('assets/images/cake/img-cake-21.jpg') }}" alt="">
                        <ul class="ps-product__action">
                          <li><a class="popup-modal" href="#quickview-modal" data-effect="mfp-zoom-out" data-tooltip="View"><i class="ps-icon--search"></i></a></li>
                          <li><a href="#" data-tooltip="Add to wishlist"><i class="ps-icon--heart"></i></a></li>
                          <li><a href="#" data-tooltip="Compare"><i class="ps-icon--reload"></i></a></li>
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                    <div class="ps-product">
                      <div class="ps-product__thumbnail">
                        <div class="ps-badge ps-badge--new"><span>New</span></div><a class="ps-product__overlay" href="{{ route('theme.product-detail') }}"></a><img src="{{ asset('assets/images/cake/img-cake-15.jpg') }}" alt="">
                        <ul class="ps-product__action">
                          <li><a class="popup-modal" href="#quickview-modal" data-effect="mfp-zoom-out" data-tooltip="View"><i class="ps-icon--search"></i></a></li>
                          <li><a href="#" data-tooltip="Add to wishlist"><i class="ps-icon--heart"></i></a></li>
                          <li><a href="#" data-tooltip="Compare"><i class="ps-icon--reload"></i></a></li>
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                    <div class="ps-product">
                      <div class="ps-product__thumbnail">
                        <div class="ps-badge"><span>-50%</span></div><a class="ps-product__overlay" href="{{ route('theme.product-detail') }}"></a><img src="{{ asset('assets/images/cake/img-cake-16.jpg') }}" alt="">
                        <ul class="ps-product__action">
                          <li><a class="popup-modal" href="#quickview-modal" data-effect="mfp-zoom-out" data-tooltip="View"><i class="ps-icon--search"></i></a></li>
                          <li><a href="#" data-tooltip="Add to wishlist"><i class="ps-icon--heart"></i></a></li>
                          <li><a href="#" data-tooltip="Compare"><i class="ps-icon--reload"></i></a></li>
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                    <div class="ps-product">
                      <div class="ps-product__thumbnail">
                        <div class="ps-badge"><span>-50%</span></div><a class="ps-product__overlay" href="{{ route('theme.product-detail') }}"></a><img src="{{ asset('assets/images/cake/img-cake-18.jpg') }}" alt="">
                        <ul class="ps-product__action">
                          <li><a class="popup-modal" href="#quickview-modal" data-effect="mfp-zoom-out" data-tooltip="View"><i class="ps-icon--search"></i></a></li>
                          <li><a href="#" data-tooltip="Add to wishlist"><i class="ps-icon--heart"></i></a></li>
                          <li><a href="#" data-tooltip="Compare"><i class="ps-icon--reload"></i></a></li>
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                    <div class="ps-product">
                      <div class="ps-product__thumbnail">
                        <div class="ps-badge ps-badge--new"><span>New</span></div><a class="ps-product__overlay" href="{{ route('theme.product-detail') }}"></a><img src="{{ asset('assets/images/cake/img-cake-20.jpg') }}" alt="">
                        <ul class="ps-product__action">
                          <li><a class="popup-modal" href="#quickview-modal" data-effect="mfp-zoom-out" data-tooltip="View"><i class="ps-icon--search"></i></a></li>
                          <li><a href="#" data-tooltip="Add to wishlist"><i class="ps-icon--heart"></i></a></li>
                          <li><a href="#" data-tooltip="Compare"><i class="ps-icon--reload"></i></a></li>
      ...
      <div class="ps-section ps-section--home-testimonial pb-30 bg--parallax" data-background="{{ asset('assets/images/parallax/img-bg-1.jpg') }}">
        <div class="container">
          <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-animate-in="" data-owl-animate-out="" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-nav-left="&lt;i class=&quot;fa fa-angle-left&quot;&gt;&lt;/i&gt;" data-owl-nav-right="&lt;i class=&quot;fa fa-angle-right&quot;&gt;&lt;/i&gt;">
            <div class="ps-testimonial text-center pt-80 pb-100">
              <div class="ps-testimonial__header">
                <div class="ps-testimonial__thumbnail"><img src="{{ asset('assets/images/testimonial/1.jpg') }}" alt=""></div>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
                  <option value="1">3</option>
            ...
            <div class="ps-testimonial text-center pt-80 pb-100">
              <div class="ps-testimonial__header">
                <div class="ps-testimonial__thumbnail"><img src="{{ asset('assets/images/testimonial/2.jpg') }}" alt=""></div>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
                  <option value="1">3</option>
            ...
            <div class="ps-testimonial text-center pt-80 pb-100">
              <div class="ps-testimonial__header">
                <div class="ps-testimonial__thumbnail"><img src="{{ asset('assets/images/testimonial/3.jpg') }}" alt=""></div>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
                  <option value="1">3</option>
            ...
            <div class="ps-testimonial text-center pt-80 pb-100">
              <div class="ps-testimonial__header">
                <div class="ps-testimonial__thumbnail"><img src="{{ asset('assets/images/testimonial/4.jpg') }}" alt=""></div>
                <select class="ps-rating">
                  <option value="1">1</option>
                  <option value="1">2</option>
                  <option value="1">3</option>
