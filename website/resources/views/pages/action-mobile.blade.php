...
@section('title', 'Bakery | Blog Detail')
...
@section('content')
    ...
    <nav class="ps-mobile-nav hidden-lg hidden-md">
      <ul class="ps-list--footer">
        <li><a href="#"><i class="ps-icon--heart"></i><span>Whishlist</span></a></li>
        <li><a href="#"><i class="ps-icon--profile"></i><span>Account</span></a></li>
        <li><a class="ps-search-btn" href="#"><i class="ps-icon--search"></i><span>Search</span></a></li>
        <li><a class="ps-cart-count" href="#"><i class="ps-icon--shopping-cart"></i><span class="quantity"><i>20</i></span><span>Cart</span></a></li>
      </ul>
    </nav>
                      ...
                      <footer class="ps-post__footer">
                        <div class="row">
                              <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 ">
                                <div class="ps-post__tags"><i class="fa fa-tags"></i><a href="{{ route('theme.blog-listing') }}">Travel</a><a href="{{ route('theme.blog-listing') }}">Balkal</a><a href="{{ route('theme.blog-listing') }}">Lake</a></div>
                              </div>
                        ...
                        <div class="ps-author-box">
                          <div class="ps-author-box__thumbnail"><img src="{{ asset('assets/images/blog/people.png') }}" alt=""></div>
                    ...
                    <div class="ps-blog-comment">
                      ...
                      <div class="ps-comment">
                            <div class="ps-comment-box">
                              <div class="ps-comment-box__thumbnail"><img src="{{ asset('assets/images/blog/people.png') }}" alt=""></div>
