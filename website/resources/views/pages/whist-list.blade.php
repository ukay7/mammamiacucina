...
@section('title', 'Bakery | Whish List')
          ...
          <div class="ps-whish-list">
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  <tr>
                    <td width="90"><img src="{{ asset('assets/images/cake/img-cake-12.jpg') }}" alt=""></td>
                    <td><a href="{{ route('theme.product-detail') }}">Amazin’ Glazin’</a></td>
                    <td>$150.00</td>
                    <td><a href="{{ route('theme.product-detail') }}">View Product</a></td>
                    <td>
                      <div class="ps-cart-listing__remove"></div>
                    </td>
                  </tr>
                  <tr>
                    <td width="90"><img src="{{ asset('assets/images/cake/img-cake-3.jpg') }}" alt=""></td>
                    <td><a href="{{ route('theme.product-detail') }}">The Crusty Croissant</a></td>
                    <td>$150.00</td>
                    <td><a href="{{ route('theme.product-detail') }}">View Product</a></td>
                    <td>
                      <div class="ps-cart-listing__remove"></div>
                  ...
                  <tr>
                    <td width="90"><img src="{{ asset('assets/images/cake/img-cake-7.jpg') }}" alt=""></td>
                    <td><a href="{{ route('theme.product-detail') }}">The Rolling Pin</a></td>
                    <td>$150.00</td>
                    <td><a href="{{ route('theme.product-detail') }}">View Product</a></td>
                    <td>
                      <div class="ps-cart-listing__remove"></div>
            ...
            <div class="text-right"><a class="ps-btn mr-5 mb-10" href="#">Back</a><a class="ps-btn" href="#">Cart and checkout</a></div>
          </div>
        </div>
      </div>
