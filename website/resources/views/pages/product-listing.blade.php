...
@section('title', 'Bakery | Product List')
        ...
        <div class="container">
          ...
          <div class="navigation__left">
                <ul class="menu menu--left">
                  ...
                  <li class="current menu-item-has-children"><a href="{{ route('theme.product-grid') }}">Products</a>
                        <ul class="sub-menu">
                          <li class="current "><a href="{{ route('theme.product-listing') }}">Product Listing</a></li>
                          <li class="current "><a href="{{ route('theme.product-grid') }}">Product Grid</a></li>
                          <li class="current "><a href="{{ route('theme.product-detail') }}">Product Detail</a></li>
                        </ul>
                  </li>
            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 col-lg-push-3 col-md-push-3">
              <div class="ps-shop-listing pt-80 pb-40">
                    <div class="ps-shop-features">
                      <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 "><img class="mb-30" src="{{ asset('assets/images/product-banner/012x.jpg') }}" alt="">
                            </div>
                            <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 "><img class="mb-30" src="{{ asset('assets/images/product-banner/022x.jpg') }}" alt="">
                            </div>
                      </div>
                    </div>
                      ...
                      <div class="row">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12 ">
                              <ul class="ps-shop-switch">
                                <li class="active"><a href="{{ route('theme.product-listing') }}"><i class="fa fa-th"></i></a></li>
                                <li><a href="{{ route('theme.product-grid') }}"><i class="fa fa-list"></i></a></li>
                              </ul>
                            </div>
                      </div>
                    </div>
                <div class="ps-shop">
                  <div class="ps-product--list ps-product--list-large">
                    ...
                    <div class="ps-product__content">
                      <h4 class="ps-product__title"><a href="{{ route('theme.product-detail') }}">Red sugar flower</a></h4>
                      ...
                      <footer class="ps-product__footer clearfix"><a class="ps-btn ps-btn--sm" href="{{ route('theme.cart') }}">Order now<i class="fa fa-angle-right"></i></a>
                  ...
                  <div class="ps-product--list ps-product--list-large">
                    <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="{{ route('theme.product-detail') }}"></a><img src="{{ asset('assets/images/cake/img-cake-3.jpg') }}" alt="">
                      <div class="ps-badge"><span>50%</span></div>
                    </div>
                    <div class="ps-product__content">
                      <h4 class="ps-product__title"><a href="{{ route('theme.product-detail') }}">Cupcake Queen</a></h4>
                      <select class="ps-rating">
                        <option value="1">1</option>
                        <option value="1">2</option>
                        <option value="1">3</option>
                  ...
                  <div class="ps-product--list ps-product--list-large">
                    ...
                    <div class="ps-product__content">
                      <h4 class="ps-product__title"><a href="{{ route('theme.product-detail') }}">Cupcake Glory</a></h4>
                      <select class="ps-rating">
                        <option value="1">1</option>
                        <option value="1">2</option>
                        <option value="1">3</option>
                  ...
                  <div class="ps-product--list ps-product--list-large">
                    <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="{{ route('theme.product-detail') }}"></a><img src="{{ asset('assets/images/cake/img-cake-5.jpg') }}" alt="">
                      <div class="ps-badge"><span>50%</span></div>
                    </div>
                    <div class="ps-product__content">
                      <h4 class="ps-product__title"><a href="{{ route('theme.product-detail') }}">Red sugar flower</a></h4>
                  ...
                  <div class="ps-product--list ps-product--list-large">
                    <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="{{ route('theme.product-detail') }}"></a><img src="{{ asset('assets/images/cake/img-cake-6.jpg') }}" alt="">
                      <div class="ps-badge"><span>50%</span></div>
                    </div>
                    <div class="ps-product__content">
                      <h4 class="ps-product__title"><a href="{{ route('theme.product-detail') }}">Cupcake Queen 2</a></h4>
                      <select class="ps-rating">
                        <option value="1">1</option>
                        <option value="1">2</option>
                        <option value="1">3</option>
                  ...
                  <div class="ps-product--list ps-product--list-large">
                    <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="{{ route('theme.product-detail') }}"></a><img src="{{ asset('assets/images/cake/img-cake-1.jpg') }}" alt="">
                      <div class="ps-badge"><span>50%</span></div>
                    </div>
                    <div class="ps-product__content">
                      <h4 class="ps-product__title"><a href="{{ route('theme.product-detail') }}">Cupcake Glory 2</a></h4>
                      <select class="ps-rating">
                        <option value="1">1</option>
                        <option value="1">2</option>
                        <option value="1">3</option>
                                ...
                                <div class="ps-widget__content">
                                  <div class="ps-product--sidebar">
                                    ...
                                    <div class="ps-product__content">
                                      ...
                                      <p class="ps-product__price">
                                        <del>£25.00</del>£15.00
                                      </p><a class="ps-btn ps-btn--xs" href="{{ route('theme.product-detail') }}">Purchase</a>
                                    </div>
                                  </div>
                                  <div class="ps-product--sidebar">
